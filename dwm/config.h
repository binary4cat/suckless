...
static       int smartgaps          = 2;        /* 1 means no outer gap when there is only one window */
...
static const char col_gray2[]       = "#000000"; /* 当static const unsigned int borderpx不为0时，非活动窗口外边框颜色 */
static const char col_gray3[]       = "#bbbbbb"; /* 当前非活动的title字体颜色 */
static const char col_gray4[]       = "#eeeeee"; /* 当前活动的title字体颜色 */
static const char col_cyan[]        = "#000000"; /* title底色 */
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_s,      spawn,          {.v = dmenucmd } },                   /* Win+s 打开dmenu */
	{ MODKEY,                       XK_Return, spawn,          {.v = termcmd } },                    /* Win+回车 打开 terminal */
  { 0,                            XK_Print,  spawn,          {.v = screenshotcmd } },              /* Ptr键 打开截屏 */
  { MODKEY|ShiftMask,             XK_l,      spawn,          {.v = screen_lock}},                  /* Win+Shift+l 锁屏 */
  { MODKEY|ShiftMask,             XK_p,      spawn,          {.v = suspendcmd}},                   /* Win+Shift+p 睡眠 */
  ...
  { MODKEY|ControlMask,           XK_grave,  spawn,          {.v = copyqtogglecmd}}, 
	...
	{ MODKEY,                       XK_j,      focusstack,     {.i = +1 } }, /* 切换聚焦的窗口 */
